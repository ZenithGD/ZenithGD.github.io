...
>
          <div className="className='mx-auto text-center flex flex-col justify-between gap-6">
            ...
            <p className='text-cyan-500 text-xl'>¿Por qué no consultar <a href={`https://cataas.com/cat/says/${encodeURIComponent('¡Miau! (¡Estamos trabajando!)')}`} className='underline'>fotos de gatitos</a> durante la espera?</p>
